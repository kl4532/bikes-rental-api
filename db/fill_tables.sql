...
VALUES (1, 'admin', 'admin', 'iam@the.boss');

INSERT INTO bike_details (id, name, values)
VALUES (1, 'type', '{road,mountain,city,electric,mtb}'),
       (2, 'size', '{kids,small,medium,large}'),
       (3, 'status', '{available,in service}')
